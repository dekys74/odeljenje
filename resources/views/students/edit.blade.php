...
@endsection
            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        {{ Form::text('rodjen', Carbon::parse($students->rodjen)->format('d.m.Y.'),  
                            [
                            'class' => 'form-control', 
                            'id'=>'datetimepicker2', 
    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-6">
            <div class="row">
                <div class="col-md-3">
                    {{ Form::button('Поништи измене', array('class' => 'btn btn-danger  btn-block', 'type'=>'reset')) }} 
               
                </div>
                <div class="col-md-3">
                    {{ Form::button('Прихвати измене',  array('class' => 'btn btn-success btn-block', 'type'=>'submit')) }} 
                </div>
            </div>  
        </div>
    </div> <!-- end of .row -->
